...
public class DateUtils {
    ...
    public static int compareDateTime(String pre, String after) {
    ...
    public static long getSecondsByCompareL(String preDatetime, String afterDatetime) {
        ...
        return (afterD.getTime() - preD.getTime())/1000;
    }
    ...
    public static void main(String[] args) throws ParseException {
        System.out.println(DateUtils.compareDateTime("2019-07-05 01:00:24", "2019-07-05 01:00:25"));
...
//        System.out.println(addMonth(dNow,4));
  ...
  System.out.println(DateUtils.getSecondsByCompareL("2019-07-05 01:00:53","2019-07-05 01:00:59"));
